...
apollo_config_db_url=jdbc:mysql://119.45.136.121:3306/ApolloConfigDB?characterEncoding=utf8
apollo_config_db_username=root
apollo_config_db_password=root

# apollo portal db info
apollo_portal_db_url=jdbc:mysql://119.45.136.121:3306/ApolloPortalDB?characterEncoding=utf8
